...
# 基本用法
python3 missav_magnet.py <missav-url>

# 安静模式，只输出链接
python3 missav_magnet.py -q <missav-url>

# 多 URL 并发
python3 missav_magnet.py url1 url2 url3

# JSON 输出
python3 missav_magnet.py -j <missav-url>

# 复制到剪贴板 (macOS)
python3 missav_magnet.py -c <missav-url>
```
...
# 命令行指定
python3 missav_magnet.py -p http://127.0.0.1:7890 <missav-url>
```
